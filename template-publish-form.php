        ...
        <div class="tab">
            ...
            <div class="form-body">
                <div class="grid-container ">
                    ...
                    <p><label class="full-width-label">Titel på event*</label><input class="full-width" placeholder="input"></p>
                    <p><label class="full-width-label">Arrangör*</label><input class="full-width" placeholder="t.ex. Agenda Jamliket"></p>
                    <p><label class="full-width-label">Datum för event*</label><input class="full-width" placeholder="Datumformat"></p>
                    <p><label class="full-width-label">Tidpunkt för event*</label><input class="full-width" placeholder="Ange start och sluttidpunkt"></p>
                    <p><label class="full-width-label">Plats för event*</label><input class="full-width" placeholder="tex Annedalsseminariet, gbg Universitet "></p>
