        ...
        <div class="cell medium-8">
            ...
            <!-- <div class="grid-container "> -->
                ...
                <div class="info-card">
                    ...
                    <a href="<?= get_site_url();?>/publish-organisation-form/" class="link">PUBLICERA I VÅR EVENTKALENDER</a>
                </div>
                <div class="info-card mint-tulip">
                    ...
                    <a href="<?= get_site_url();?>/publish-event-form/" class="link">PUBLICERA din profil här </a>
                </div>
                <div class="content">
                    <?= the_content(); ?>
                </div>
