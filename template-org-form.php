        ...
        <div class="tab">
            ...
            <div class="form-body">
                <div class="grid-container ">
                    ...
                    <p><label class="full-width-label">Organisationens namn*</label><input class="full-width" placeholder="ex. Agenda: Jämlikhet"></p>
                    <p><label class="full-width-label">Hemsida, webbadress</label><input class="full-width" placeholder="ex. agendajamliket.se"></p>
                    <p><label class="full-width-label">Mailadress till organisationen (ex till en infomail)</label><input class="full-width" placeholder="ex. info@agendajamliket.se"></p>
                    <p><label class="full-width-label">Länk till sociala medier</label><input class="full-width" placeholder="ex. instagram.se/agendajamliket/"></p>
                    <p><label class="full-width-label">Ort/kommun*</label><input class="full-width" placeholder="ex. agendajamliket.se "></p>
