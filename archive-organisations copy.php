...
<section class="connect-card-wrap connect-event-orgnisation">
    <div class="grid-container">
        <div class="title-wrap"><a href="<?= get_site_url();?>/publish/" class="see-few-all">Se färre</a></div>
            ...
            <div class="cell large-6">
                <div class="connect-card blue">
                    <div class="content">
                        ...
                        <a href="<?= get_site_url();?>/publish/" class="connect-link">ANSLUT DIN DIN ORGANISATION TILL AGENDA: JÄMLIKHET</a>
                    </div>
                </div>
            </div>
            <div class="cell large-6">
